...
if __name__ == "__main__":
    ...
    # label_train_names = check_label_name("MOSI-mosei-lable.csv", "train")
    # label_valid_names = check_label_name("MOSI-mosei-lable.csv", "valid")
    # label_test_names = check_label_name("MOSI-mosei-lable.csv", "test")
